...
Report bugs at https://github.com/jakirkham/dask-ndmeasure/issues.
...
dask-ndmeasure could always use more documentation, whether as part of the
official dask-ndmeasure docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/jakirkham/dask-ndmeasure/issues.
...
3. The pull request should work for Python 2.7, 3.4, 3.5, and 3.6. Check
   https://travis-ci.org/jakirkham/dask-ndmeasure/pull_requests
