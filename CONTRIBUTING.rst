...
Report bugs at https://github.com/jakirkham/dask-image/issues.
...
The best way to send feedback is to file an issue at https://github.com/jakirkham/dask-image/issues.
...
3. The pull request should work for Python 2.7, 3.4, 3.5, and 3.6. Check
   https://travis-ci.org/jakirkham/dask-image/pull_requests
